...
@AllArgsConstructor
@Builder
public class OasisAssessmentDTO {
    ...
    private Map<String, Boolean> sectionCompletion; // {"section1": true, "section2": false}
    private List<String> skippedFields; // ["M1005", "M1307", ...]
    ...
    public boolean shouldShowPhq9() {
        Integer phq2Score = getPhq2Score();
